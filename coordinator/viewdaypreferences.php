...
<?php	
          ...
          // $query="SELECT daypreference.*,faculty.username FROM daypreference INNER JoiN faculty ON faculty.faculty_id=daypreference.fac_id   ";
		$query="SELECT  *  FROM daypreference    ";
		
		$result= mysqli_query($link,$query);$i=1;
 ...
 $day=$row['day'];   
   ...
   ?>
                                 ...
                                 <tr>
							       ...
							       <td><?Php echo $id; ?></td>	
								    <td><?Php  echo facultyname($link,$fac_id); ?></td>	
									<td><?Php echo $day ;?></td>								   
